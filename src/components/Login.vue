  ...
  <section class="background">
    <section class="overlay">
      <div class="text">
       ...
       <span v-if="messages.errorMessage !== undefined || messages.errorMessage !== ''"
        class="notValid"
      >{{messages.errorMessage}}</span>
      <div class="inputs">
        <label for="name-input" class="labels">Namn
       <span v-if="!validate.name"
        class="notValid"
      >{{messages.nameMessage}}</span>

        </label>
        <input v-model="userData.name" type="text" id="name-input" @input="validateName"/>
        <label for="email-input" class="labels">Epost
           <span v-if="!validate.email"
        class="notValid"
      >{{messages.emailMessage}}</span>
        </label>
        <input v-model="userData.email" type="text" id="email-input" @input="validateEmail" />
        <div class="radio">
...
export default {
  ...
  methods: {
   ...
   createUser(userData) {
     ...
     this.$store.dispatch('getUserOrderHistory',userData.email);
       }
   }
  }
};
